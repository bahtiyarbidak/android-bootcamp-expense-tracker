...
import com.example.expensetracker.databinding.FragmentOnboardingThreeBinding
...
class FragmentOnboardingThree : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonThree.setOnClickListener {
            this.findNavController().navigate(FragmentOnboardingThreeDirections.actionFragmentOnboardingThreeToExpenseListFragment())
        }
    }
}