...
class ExpenseAdapter(private val clickListener: ExpenseListener): ListAdapter<Expense, ExpenseAdapter.ViewHolder>(ExpenseDiffCallback()) {
    ...
    class ViewHolder private constructor(private val binding: ListItemExpenseBinding) : RecyclerView.ViewHolder(binding.root){
